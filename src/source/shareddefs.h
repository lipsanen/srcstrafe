...
namespace Strafe
{
    ...
    #define VEC_HULL_MAX		Vector(32, 32, 72)

    #define VEC_DUCK_HULL_MIN	Vector(0, 0, 0)
    #define VEC_DUCK_HULL_MAX	Vector(32, 32, 36)

    // TODO: These are incorrect
    #define VEC_DUCK_VIEW		Vector(0, 0, 28)
    #define VEC_VIEW Vector(0, 0, 64)

    #define VEC_OBS_HULL_MIN	Vector(0, 0, 0)
    #define VEC_OBS_HULL_MAX	Vector(0, 0, 0)

    #define VEC_DEAD_VIEWHEIGHT	Vector(0, 0, 0)
